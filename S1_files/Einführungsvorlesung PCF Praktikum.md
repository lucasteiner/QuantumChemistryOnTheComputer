(Note to self)
What does a QC-Program do?
- Name: ORCA
- Method: DFT (PBE0/def2-TZVP)
- Goals: Calculate the electronic structure of molecules, optimize the geometric structure to obtain equilibirum structures, normal mode analysis, transition state optimization and much much more !
